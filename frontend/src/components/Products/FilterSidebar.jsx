...
const FilterSidebar = () => {
    ...
    const materials = ["Cotton", "Polyester", "Wool", "Silk", "Denim", "Linen", "Fleece"];
    const brands = ["Urban Threads", "Modern Fit", "Street Style", "Beach Breeze", "Fashionsta"];
    ...
    const handlePriceChange =  (e) =>{
        ...
        const newFilters = {...filters,minprice:0,newPrice};
        setFilters(filters);
        updateURLParams(newFilters);
    }
